...
const Links = (): React.ReactElement<{
    ...
    <section id="where-to-find-me" className="p-2">
        ...
        <p>My website: <a className="text-blue-600 hover:underline" href="https://jsmon.vercel.app/" target="_blank" rel="noopener noreferrer">jsmon.vercel.app</a></p>
        ...
        <p>Email me: <a className="text-blue-600 hover:underline" href="mailto:jsmon.dev@gmail.com" target="_blank" rel="noopener noreferrer">jsmon.dev@gmail.com</a></p>
    </section>
);
